						...
						<div class="row">
							...
							<div class="col-md-3">
								<img alt="kakaopay" onclick="kakaoPayProcess()"
									class="rounded-lg payimg" src="static/images/pay-kakao.png">
							</div>
							<div class="col-md-3">
								<img alt="toss" onclick="tossPayProcess()"
									src="static/images/pay-toss.png" class="rounded-lg payimg">
							</div>
							<!-- <div class="col-md-3">
								<img alt="payco" src="static/images/pay-payco.png"
									onclick="paycoProcess()" class="rounded-lg payimg">
							</div> -->
							<div class="col-md-3">
								<img alt="card" src="static/images/pay-card.png"
